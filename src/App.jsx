...
const autoGeneratedFields = new Set(['id', '_rowid_', 'claim_number', 'data_zgloszenia', 'status', 'utworzono', 'dzial']);
  ...
  const addFormColumns = useMemo(() => {
    if (schema.length) {
      return schema
        ...
        .filter((column) => !autoGeneratedFields.has(column.toLowerCase()) && column.toLowerCase() !== 'zglaszajacy');
    }

    return editableColumns.filter((column) => !autoGeneratedFields.has(column.toLowerCase()));
